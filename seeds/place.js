...
async function seedPlaces() {
    ...
    //membuat data places dengan ditambah data author dari id 66e794a0a54a57e94632f432
    const authorId = '66e794a0a54a57e94632f432';

    // Menyimpan data places dengan ditambahkan data author
    for (let i = 0; i < places.length; i++) {
        const place = new Place(places[i]);
        place.author = authorId;  // Menetapkan ID author untuk setiap place
        await place.save();
    }
